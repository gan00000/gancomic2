...
public class LocalFavoritesDao extends AbstractDao<LocalFavoriteInfo, Long> {
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, LocalFavoriteInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void bindValues(DatabaseStatement stmt, LocalFavoriteInfo entity) {

    }

    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(LocalFavoriteInfo entity, long rowId) {
        entity.setGid(rowId);
        return rowId;
    }
