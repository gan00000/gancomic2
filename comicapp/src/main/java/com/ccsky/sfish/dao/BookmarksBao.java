...
public class BookmarksBao extends AbstractDao<BookmarkInfo, Long> {
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, BookmarkInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void bindValues(DatabaseStatement stmt, BookmarkInfo entity) {

    }

    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(BookmarkInfo entity, long rowId) {
        entity.setGid(rowId);
        return rowId;
    }
