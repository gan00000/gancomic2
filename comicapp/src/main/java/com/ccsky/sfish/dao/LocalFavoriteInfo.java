...
public class LocalFavoriteInfo extends GalleryInfo {
	...
	public LocalFavoriteInfo(long gid, String token, String title,
			String titleJpn, String thumb, int category, String posted,
			String uploader, float rating, String simpleLanguage, long time) {
		this.gid = gid;
		this.token = token;
		this.title = title;
