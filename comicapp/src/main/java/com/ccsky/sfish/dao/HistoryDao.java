...
public class HistoryDao extends AbstractDao<HistoryInfo, Long> {
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, HistoryInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void bindValues(DatabaseStatement stmt, HistoryInfo entity) {

    }

    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(HistoryInfo entity, long rowId) {
        entity.setGid(rowId);
        return rowId;
    }
