...
public class DownloadLabelDao extends AbstractDao<DownloadLabel, Long> {
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, DownloadLabel entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void bindValues(DatabaseStatement stmt, DownloadLabel entity) {

    }

    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(DownloadLabel entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
