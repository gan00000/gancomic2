...
public abstract class GalleryInfoContentHelper extends ContentLayout.ContentHelper<GalleryInfo> {
  ...
  public GalleryInfoContentHelper() {
    ...
    SkyApplication.getFavouriteStatusRouter().addListener(listener);
  }

  public void destroy() {
    SkyApplication.getFavouriteStatusRouter().removeListener(listener);
  }
  ...
  protected Parcelable saveInstanceState(Parcelable superState) {
    ...
    FavouriteStatusRouter router = SkyApplication.getFavouriteStatusRouter();
