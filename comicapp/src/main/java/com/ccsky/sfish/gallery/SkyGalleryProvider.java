...
public class SkyGalleryProvider extends GalleryProvider2 implements SpiderQueen.OnSpiderListener {
    ...
    public SkyGalleryProvider(Context context, GalleryInfo galleryInfo) {
        mContext = context;
