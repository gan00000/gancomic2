...
public class RestoreDownloadPreference extends TaskPreference {
    ...
    private static class RestoreTask extends Task {
        ...
        public RestoreTask(@NonNull Context context) {
            ...
            mManager = SkyApplication.getDownloadManager(mApplication);
            mHttpClient = SkyApplication.getOkHttpClient(mApplication);
        }
        ...
        protected Object doInBackground(Void... params) {
            ...
            try {
                return SkyEngine.fillGalleryListByApi(null, mHttpClient, new ArrayList<GalleryInfo>(restoreItemList), SkyUrl.getReferer());
            } catch (Throwable e) {
                ...
                if (list.isEmpty()) {
                    ...
                    for (int i = 0, n = list.size(); i < n; i++) {
                        ...
                        if (null != item.title) {
                            ...
                            SkyDB.putDownloadDirname(item.gid, item.dirname);
                            count++;
                        }
                    }
