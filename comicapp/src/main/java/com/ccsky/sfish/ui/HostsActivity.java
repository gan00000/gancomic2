...
public class HostsActivity extends ToolbarActivity
  ...
  private static final String KEY_HOST = "HostsActivity.HOST";
  private static final String KEY_IP = "HostsActivity.IP";
  ...
  protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    hosts = SkyApplication.getHosts(this);
    data = hosts.getAll();
