...
import com.ccsky.sfish.gallery.DirGalleryProvider;
import com.ccsky.sfish.gallery.SkyGalleryProvider;
import com.ccsky.sfish.gallery.GalleryProvider2;
import com.ccsky.sfish.widget.GalleryGuideView;
import com.ccsky.sfish.widget.ReversibleSeekBar;
...
import com.ccsky.sfish.gallery.ArchiveGalleryProvider;
...
import com.ccsky.util.SystemUiHelper;
import com.ccsky.widget.ColorView;
...
public class SkyGalleryActivity extends SkyActivity implements SeekBar.OnSeekBarChangeListener,
    ...
    private void buildProvider() {
        ...
        if (ACTION_DIR.equals(mAction)) {
            ...
            if (mGalleryInfo != null) {
                mGalleryProvider = new SkyGalleryProvider(this, mGalleryInfo);
            }
    ...
    private void showPageDialog(final int page) {
        Resources resources = SkyGalleryActivity.this.getResources();
        AlertDialog.Builder builder = new AlertDialog.Builder(SkyGalleryActivity.this);
        ...
        public void run() {
            switch (mKey) {
                case KEY_LAYOUT_MODE:
                    SkyGalleryActivity.this.mLayoutMode = mValue;
                    updateSlider();
                    break;
                case KEY_SIZE:
                    SkyGalleryActivity.this.mSize = mValue;
                    updateSlider();
                    updateProgress();
                    break;
                case KEY_CURRENT_INDEX:
                    SkyGalleryActivity.this.mCurrentIndex = mValue;
                    updateSlider();
                    updateProgress();
                    break;
