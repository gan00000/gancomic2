...
public class DownloadLabelsScene extends ToolbarScene {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mList = SkyApplication.getDownloadManager(getContext2()).getLabelList();
    }
...
//        }
    ...
    private class NewLabelDialogHelper implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            } else if (SkyApplication.getDownloadManager(context).containLabel(text)) {
                mBuilder.setError(getString(R.string.label_text_exist));
            } else {
                mBuilder.setError(null);
                mDialog.dismiss();
                SkyApplication.getDownloadManager(context).addLabel(text);
    ...
    private class RenameLabelDialogHelper implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (TextUtils.isEmpty(text)) {
                ...
                mBuilder.setError(null);
                mDialog.dismiss();
                SkyApplication.getDownloadManager(context).renameLabel(mOriginalLabel, text);
                if (mAdapter != null) {
                ...
                new AlertDialog.Builder(context)
                    ...
                    .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            SkyApplication.getDownloadManager(context).deleteLabel(label.getLabel());
                        }
                    })
    ...
    private class LabelAdapter extends RecyclerView.Adapter<LabelHolder>
        ...
        public void onMoveItem(int fromPosition, int toPosition) {
            ...
            SkyApplication.getDownloadManager(context).moveLabel(fromPosition, toPosition);
        }
