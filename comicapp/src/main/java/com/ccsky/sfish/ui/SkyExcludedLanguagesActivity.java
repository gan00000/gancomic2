...
import com.ccsky.widget.SensitiveCheckBox;
import com.hippo.yorozuya.ViewUtils;

public class SkyExcludedLanguagesActivity extends ToolbarActivity
    ...
    private static final String[] LANGUAGES = {
            SkyConfig.JAPANESE_ORIGINAL,
            SkyConfig.JAPANESE_TRANSLATED,
            SkyConfig.JAPANESE_REWRITE,
            SkyConfig.ENGLISH_ORIGINAL,
            SkyConfig.ENGLISH_TRANSLATED,
            SkyConfig.ENGLISH_REWRITE,
            SkyConfig.CHINESE_ORIGINAL,
            SkyConfig.CHINESE_TRANSLATED,
            SkyConfig.CHINESE_REWRITE,
            SkyConfig.DUTCH_ORIGINAL,
            SkyConfig.DUTCH_TRANSLATED,
            SkyConfig.DUTCH_REWRITE,
            SkyConfig.FRENCH_ORIGINAL,
            SkyConfig.FRENCH_TRANSLATED,
            SkyConfig.FRENCH_REWRITE,
            SkyConfig.GERMAN_ORIGINAL,
            SkyConfig.GERMAN_TRANSLATED,
            SkyConfig.GERMAN_REWRITE,
            SkyConfig.HUNGARIAN_ORIGINAL,
            SkyConfig.HUNGARIAN_TRANSLATED,
            SkyConfig.HUNGARIAN_REWRITE,
            SkyConfig.ITALIAN_ORIGINAL,
            SkyConfig.ITALIAN_TRANSLATED,
            SkyConfig.ITALIAN_REWRITE,
            SkyConfig.KOREAN_ORIGINAL,
            SkyConfig.KOREAN_TRANSLATED,
            SkyConfig.KOREAN_REWRITE,
            SkyConfig.POLISH_ORIGINAL,
            SkyConfig.POLISH_TRANSLATED,
            SkyConfig.POLISH_REWRITE,
            SkyConfig.PORTUGUESE_ORIGINAL,
            SkyConfig.PORTUGUESE_TRANSLATED,
            SkyConfig.PORTUGUESE_REWRITE,
            SkyConfig.RUSSIAN_ORIGINAL,
            SkyConfig.RUSSIAN_TRANSLATED,
            SkyConfig.RUSSIAN_REWRITE,
            SkyConfig.SPANISH_ORIGINAL,
            SkyConfig.SPANISH_TRANSLATED,
            SkyConfig.SPANISH_REWRITE,
            SkyConfig.THAI_ORIGINAL,
            SkyConfig.THAI_TRANSLATED,
            SkyConfig.THAI_REWRITE,
            SkyConfig.VIETNAMESE_ORIGINAL,
            SkyConfig.VIETNAMESE_TRANSLATED,
            SkyConfig.VIETNAMESE_REWRITE,
            SkyConfig.NA_ORIGINAL,
            SkyConfig.NA_TRANSLATED,
            SkyConfig.NA_REWRITE,
            SkyConfig.OTHER_ORIGINAL,
            SkyConfig.OTHER_TRANSLATED,
            SkyConfig.OTHER_REWRITE};
