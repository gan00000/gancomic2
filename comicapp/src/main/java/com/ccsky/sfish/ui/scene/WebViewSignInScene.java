...
public class WebViewSignInScene extends SkySolidScene {
    ...
    public View onCreateView2(LayoutInflater inflater,
        ...
        mWebView.loadUrl(SkyUrl.URL_SIGN_IN);
        return mWebView;
    }
    ...
    private class LoginWebViewClient extends WebViewClient {
        ...
        private void addCookie(Context context, String domain, Cookie cookie) {
            SkyApplication.getEhCookieStore(context).addCookie(EhCookieStore.newCookie(cookie, domain, true, true, true));
        }
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            String cookieString = CookieManager.getInstance().getCookie(SkyUrl.HOST_E);
            ...
            for (Cookie cookie: cookies) {
                ...
                addCookie(context, SkyUrl.DOMAIN_EX, cookie);
                addCookie(context, SkyUrl.DOMAIN_E, cookie);
            }
