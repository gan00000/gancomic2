...
import com.ccsky.sfish.dao.DaoSession;
import com.ccsky.sfish.dao.DownloadDirname;
import com.ccsky.sfish.dao.DownloadDirnameDao;
import com.ccsky.sfish.dao.DownloadInfo;
import com.ccsky.sfish.dao.DownloadLabel;
import com.ccsky.sfish.dao.DownloadLabelDao;
import com.ccsky.sfish.dao.DownloadsDao;
import com.ccsky.sfish.dao.Filter;
import com.ccsky.sfish.dao.FilterDao;
import com.ccsky.sfish.dao.HistoryDao;
import com.ccsky.sfish.dao.HistoryInfo;
import com.ccsky.sfish.dao.LocalFavoriteInfo;
import com.ccsky.sfish.dao.LocalFavoritesDao;
import com.ccsky.sfish.dao.QuickSearch;
import com.ccsky.sfish.dao.QuickSearchDao;
import com.ccsky.sfish.download.DownloadManager;
import com.ccsky.util.ExceptionUtils;
import com.ccsky.util.SqlUtils;
...
public class SkyDB {
    ...
    private static final String TAG = SkyDB.class.getSimpleName();
    ...
    public static synchronized String importDB(Context context, File file) {
        try {
            ...
            // Downloads
            DownloadManager manager = SkyApplication.getDownloadManager(context);
