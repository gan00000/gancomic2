...
public class Settings {
    ...
    private static SkyConfig loadEhConfig() {
        SkyConfig skyConfig = new SkyConfig();
        skyConfig.imageSize = getImageResolution();
        skyConfig.excludedLanguages = getExcludedLanguages();
        skyConfig.defaultCategories = getDefaultCategories();
        skyConfig.excludedNamespaces = getExcludedTagNamespaces();
        skyConfig.setDirty();
        return skyConfig;
    }
    ...
    public static SkyConfig getEhConfig() {
        return sSkyConfig;
    }
    ...
    public static final int DEFAULT_DEFAULT_CATEGORIES = SkyUtils.ALL_CATEGORY;
    ...
    public static void putDefaultCategories(int value) {
        sSkyConfig.defaultCategories = value;
        sSkyConfig.setDirty();
    ...
    public static void putExcludedTagNamespaces(int value) {
        sSkyConfig.excludedNamespaces = value;
        sSkyConfig.setDirty();
    ...
    public static void putExcludedLanguages(String value) {
        sSkyConfig.excludedLanguages = value;
        sSkyConfig.setDirty();
    ...
    public static final String DEFAULT_IMAGE_RESOLUTION = SkyConfig.IMAGE_SIZE_AUTO;
    ...
    private static final boolean DEFAULT_BETA_UPDATE_CHANNEL = SkyApplication.BETA;
    ...
    private static final boolean DEFAULT_SAVE_PARSE_ERROR_BODY = SkyApplication.BETA;
    ...
    private static final int DEFAULT_PROXY_TYPE = SkyProxySelector.TYPE_SYSTEM;
