...
public class SkyUrl {
    ...
    public static final String API_DOMMAIN = "https://forums.e-hentai.org";

    public static final String HOST_EX = "https://" + DOMAIN_EX + "/";
    public static final String HOST_E = "https://" + DOMAIN_E + "/";

    public static final String API_SIGN_IN = API_DOMMAIN + "/index.php?act=Login&CODE=01";
    ...
    public static final String URL_SIGN_IN = API_DOMMAIN + "/index.php?act=Login";
    public static final String URL_REGISTER = API_DOMMAIN + "/index.php?act=Reg&CODE=00";
    ...
    public static final String URL_FORUMS = SkyUrl.API_DOMMAIN + "/";
