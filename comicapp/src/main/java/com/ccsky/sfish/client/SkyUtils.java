...
public class SkyUtils {
    ...
    public static final int ALL_CATEGORY = SkyUtils.UNKNOWN - 1;
    ...
    public static int getCategoryColor(int category) {
        switch (category) {
            case SkyConfig.DOUJINSHI:
                return BG_COLOR_DOUJINSHI;
            case SkyConfig.MANGA:
                return BG_COLOR_MANGA;
            case SkyConfig.ARTIST_CG:
                return BG_COLOR_ARTIST_CG;
            case SkyConfig.GAME_CG:
                return BG_COLOR_GAME_CG;
            case SkyConfig.WESTERN:
                return BG_COLOR_WESTERN;
            case SkyConfig.NON_H:
                return BG_COLOR_NON_H;
            case SkyConfig.IMAGE_SET:
                return BG_COLOR_IMAGE_SET;
            case SkyConfig.COSPLAY:
                return BG_COLOR_COSPLAY;
            case SkyConfig.ASIAN_PORN:
    ...
    public static void signOut(Context context) {
        SkyApplication.getEhCookieStore(context).signOut();
    ...
    public static boolean needSignedIn(Context context) {
        return Settings.getNeedSignIn() && !SkyApplication.getEhCookieStore(context).hasSignedIn();
    }
