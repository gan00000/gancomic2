...
public class LargePreviewSet extends PreviewSet {
    ...
    public GalleryPreview getGalleryPreview(long gid, int index) {
        ...
        galleryPreview.imageKey = SkyCacheKeyFactory.getLargePreviewKey(gid, galleryPreview.position);
    ...
    public void load(LoadImageView view, long gid, int index) {
        view.resetClip();
        view.load(SkyCacheKeyFactory.getLargePreviewKey(gid, mPositionList.get(index)),
